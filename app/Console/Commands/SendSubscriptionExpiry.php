...
class SendSubscriptionExpiry extends Command
{
    ...
    public function handle()
    {
        ...
        $before_days_for_send_expiry_mail = (isset($admin_settings['days_for_send_expiry_mail'])) ? $admin_settings['days_for_send_expiry_mail'] : 15;
        ...
        if(count($users_subscriptions) > 0)
        {
            foreach($users_subscriptions as $user_subscription)
            {
                ...
                if($remaining_days == $before_days_for_send_expiry_mail)
                {
                    ...
                    $custom_message = "Your Shop Subscription has been Expired At";
                    ...
                    if(!empty($contact_us_email) && !empty($user_mail))
                    {
                        ...
                        $message = str_replace('{message}',$custom_message,$message);
