        ...
        <div class="site_info">
            <form id="generalInfo" action="{{ route('design.generalInfoUpdate') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-label" for="order_mail_template">{{ __('Orders Mail Template') }}</label>
                            <textarea name="order_mail_template" id="order_mail_template" class="form-control">{{ (isset($client_settings['order_mail_template']) && !empty($client_settings['order_mail_template'])) ? $client_settings['order_mail_template'] : '' }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
