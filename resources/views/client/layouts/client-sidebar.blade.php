...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        {{-- Settings Nav --}}
        <li class="nav-item">
            <a class="nav-link {{ (($routeName != 'billing.info') && ($routeName != 'billing.info.edit') && ($routeName != 'design.general-info') && ($routeName != 'client.subscription') && ($routeName != 'design.mail.forms') && ($routeName != 'languages') && ($routeName != 'payment.settings') && ($routeName != 'order.settings') && ($routeName != 'printer.settings')) ? 'collapsed' : '' }} {{ (($routeName == 'billing.info') || ($routeName == 'billing.info.edit') || ($routeName == 'design.general-info') || ($routeName == 'client.subscription') || ($routeName == 'design.mail.forms') || ($routeName == 'languages') || ($routeName == 'payment.settings') || ($routeName == 'order.settings') | ($routeName == 'printer.settings')) ? 'active-tab' : '' }}" data-bs-target="#settings-nav" data-bs-toggle="collapse" href="#" aria-expanded="{{ (($routeName == 'billing.info') || ($routeName == 'billing.info.edit') || ($routeName == 'design.general-info') || ($routeName == 'client.subscription') || ($routeName == 'design.mail.forms') || ($routeName == 'languages') || ($routeName == 'payment.settings') || ($routeName == 'order.settings') || ($routeName == 'order.settings') | ($routeName == 'printer.settings')) ? 'true' : 'false' }}">
                <i class="fa-solid fa-gear  {{ (($routeName == 'billing.info') || ($routeName == 'billing.info.edit') || ($routeName == 'design.general-info') || ($routeName == 'client.subscription') || ($routeName == 'design.mail.forms') || ($routeName == 'languages') || ($routeName == 'payment.settings') || ($routeName == 'order.settings') || ($routeName == 'order.settings') | ($routeName == 'printer.settings')) ? 'icon-tab' : '' }}"></i><span>{{ __('Settings') }}</span><i class="bi bi-chevron-down ms-auto {{ (($routeName == 'billing.info') || ($routeName == 'billing.info.edit') || ($routeName == 'design.general-info') || ($routeName == 'client.subscription') || ($routeName == 'design.mail.forms') || ($routeName == 'languages') || ($routeName == 'payment.settings') || ($routeName == 'order.settings') || ($routeName == 'order.settings') | ($routeName == 'printer.settings')) ? 'icon-tab' : '' }}"></i>
            </a>
            <ul id="settings-nav" class="nav-content sidebar-ul collapse  {{ (($routeName == 'billing.info') || ($routeName == 'billing.info.edit') || ($routeName == 'design.general-info') || ($routeName == 'client.subscription') || ($routeName == 'design.mail.forms') || ($routeName == 'languages') || ($routeName == 'payment.settings') || ($routeName == 'order.settings') || ($routeName == 'order.settings') | ($routeName == 'printer.settings')) ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
