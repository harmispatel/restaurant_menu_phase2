                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="wp_number" id="wp_number" class="form-control {{ ($errors->has('wp_number')) ? 'is-invalid' : '' }}" placeholder="Enter Whatsapp Number" value="{{ $staff->wp_number }}">
