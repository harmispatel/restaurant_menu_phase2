                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="cc-exp" class="form-label">CARD EXPIRY</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="cc-cvc" class="form-label">CARD CVC</label>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="numeric" class="form-label">CARD HOLDER NAME</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-success">Pay {{ $total_amount_text }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
